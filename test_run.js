...
// Read model.js and remove ESM exports to eval it safely
const code = fs.readFileSync('./src/model.js', 'utf8').replace(/export function/g, 'function').replace(/export const/g, 'const');
eval(code);
